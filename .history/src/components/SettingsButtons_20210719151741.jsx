...
const SettingsButtons = ({dbData, runFunction, types, change, additionalText}) => {
    ...
    return (
        ...
        { change == "englishType" &&
            <div>
                <input onChange={changed} placeholder={dbData ? dbData.englishType : null} type="text" style={{width:"250px",marginBottom:"2px"}}/>
                {/* <input onChange={changed} type="submit" style={{width:"250px",marginBottom:"20px",backgroundColor:"#2D2F31",justifyContent:"center",textAlign:"center"}}/> */}
            </div>
        }
        </div>
    )
