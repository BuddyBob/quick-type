...
const SettingsButtons = ({runFunction, types, localStorageName, additionalText}) => {
    ...
    function returnUserData(userId){
      ...
      console.log("NO NO NO ACTUALLY I AM",wordCount)
      useEffect(() => {
        if (loggedIn){
    ...
    console.log("OK FINE I'M SECOND",wordCount)
    const theme = {
        dark: {
            default: '#2D2F31',
            hover: '#ede8e8'
    ...
    console.log("NO I AM HERE FIRST? ")
    let index;
