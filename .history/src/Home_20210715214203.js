...
let returnUserData = async function(userId){
...
let userToken = await returnUserData(localStorage.getItem("currentUserId"))
console.log(userToken)
// console.log("HELLO",returnUserData(localStorage.getItem("currentUserId")))
setData()
let interval = null
const Home = () =>  {
  // set hooks
