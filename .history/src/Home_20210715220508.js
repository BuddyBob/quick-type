...
const Home = () =>  {
  ...
  returnUserData(localStorage.getItem("currentUserId")).then(result => {
    const [text,setText] = useState(loggedIn ? GetText(result.wordCount,result.englishType) : GetText(localStorage.getItem('wordCount'),localStorage.getItem('englishType')))
  })
