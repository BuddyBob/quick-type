            ...
            <div>
                ...
                <div className="wrapper fadeInDown">
                    <div id="formContent">
                        ...
                        <h2 className="register-title">Quick Type - Pwd Reset</h2>
                        </div>
                        ...
                        <div className="redirect-register">
                            <Link to="/login" style={{ textDecoration: 'none' }}><span style={{textDecoration:"underline #ffdc7a"}} className="redirect-register-text">Login</span></Link>
                        </div>
                    </div>
                </div>
            </div>
